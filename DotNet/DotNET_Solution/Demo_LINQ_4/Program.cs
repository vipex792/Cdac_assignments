    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Emp> emps = new List<Emp>() {
                new Emp(){ Id=11, Name="Jasmit",Address="Nagpur"},
                new Emp(){ Id=12, Name="Bhatu",Address="Dhule"},
                new Emp(){ Id=13, Name="Mahesh",Address="Ratnagiri"},
                new Emp(){ Id=14, Name="Harsh",Address="Raipur"},
                new Emp(){ Id=15, Name="Jignesh",Address="Pune"},
                new Emp(){ Id=16, Name="Jayesh",Address="Pune"},
                new Emp(){ Id=17, Name="Gukesh",Address="Mumbai"},
                new Emp(){ Id=18, Name="Hamza",Address="Karachi"},
                new Emp(){ Id=19, Name="Rahaman",Address="Lahore"},
            ...
            emps.Add(new Emp() { Id = 20, Name = "Pintya", Address = "Meesho" });
